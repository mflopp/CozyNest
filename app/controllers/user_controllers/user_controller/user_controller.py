...
from .methods import (
    add_user, del_user, fetch_users, fetch_user,
    update_user_data, fetch_only_user
)
...
class UserController:
    ...
    @staticmethod
    def get_minimum(user_id: int, session: Session) -> User:
        user = fetch_only_user(user_id, session)
        return user
